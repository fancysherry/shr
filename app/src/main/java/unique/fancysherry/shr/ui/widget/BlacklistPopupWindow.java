...
public class BlacklistPopupWindow extends PopupWindow {
  ...
  public BlacklistPopupWindow(Context context, OnClickListener itemsOnClick) {
    super(context);
    LayoutInflater inflater = (LayoutInflater) context
        .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    mMenuView = inflater.inflate(R.layout.layout_dialog_putblacklist, null);
    putblack = (TextView) mMenuView.findViewById(R.id.putblack);
